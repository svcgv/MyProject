...
public class CommentGet {
    ...
    public CommentGet(String url, Comment comment) {
        this.url = url;
    ...
    public int SendMessage(){
        ...
        try {
            ...
            conn.setRequestProperty("Content-Type", CONTENT_TYPE + ";boundary="+ BOUNDARY);
                ...
                sb.append(LINE_END);
                sb.append(comment.username + LINE_END);
                sb.append(PREFIX);
                sb.append(BOUNDARY);
                sb.append(LINE_END);
                /**
            ...
            sb.append(LINE_END);
            sb.append(comment.comment_id + LINE_END);
            sb.append(PREFIX);
            sb.append(BOUNDARY);
            sb.append(LINE_END);

            sb.append("Content-Disposition: form-data; name=\"comment\"" + LINE_END);
            sb.append(LINE_END);
            sb.append(comment.commt + LINE_END);
            sb.append(PREFIX);
            sb.append(BOUNDARY);
             sb.append(LINE_END);
